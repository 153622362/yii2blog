...
{    
    ...
    {
        $this->items = [
            [   'label' =>'<i class="fa fa-dashboard"></i><span>仪表盘</span>',
                'url'=>['site/index']
            ],
                ...
                'items'=>[
                    [   'label'=>'文章管理',
                        ...
                        'items'=>[
                                     ...
                                     ['label'=>'会员详情','url' =>['post/view'], 'visible' => false],
                        ]                       
                    ],
                    [   'label'=>'分类管理',
                        'url'=>['cat/index'],
                        'items'=>[
                                     ['label'=>'创建文章分类','url'=>['cat/create'],'visible'=>false],
                                     ['label'=>'更新文章分类','url'=>['cat/update'],'visible'=>false],
                    ...
                    [   'label'=>'标签管理',
                        ...
                        'items'=>[
                                     ...
                                     ['label'=>'会员详情','url' =>['tag/view'], 'visible' => false],
                     ]
